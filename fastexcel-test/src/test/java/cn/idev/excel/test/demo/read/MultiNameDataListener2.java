 ...
 */
@Slf4j
public class MultiNameDataListener2 extends AnalysisEventListener<MultiNameData2> {
    ...
    private List<MultiNameData2> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);

    @Override
    public void invoke(MultiNameData2 data, AnalysisContext context) {
